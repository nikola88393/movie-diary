...
const CardNav: React.FC<CardNavProps> = ({
  ...
  const createTimeline = () => {
    ...
    tl.to(cardsRef.current, { y: 0, opacity: 1, duration: 0.2, ease, stagger: 0.08 }, '-=0.1');
  ...
  const toggleMenu = (href?: string) => {
    ...
    if (!isExpanded) {
      ...
      } else tl.eventCallback('onReverseComplete', () => setIsExpanded(false));
      tl.reverse();
    }
  };
